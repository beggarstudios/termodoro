...
func (c *StartCmd) Run(globals *StartupParameters) error {
	return launchStarter(globals, tui.MenuView, views.NewMenuModel())
}

func launchStarter(globals *StartupParameters, starterMode tui.Mode, switchIn tui.SwitchModeInput) error {
